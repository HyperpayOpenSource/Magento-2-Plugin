 ...
 *
 */
class Hyperpay_Model_Method_Stc extends Hyperpay_Model_Method_Abstract
{
     ...
     * @var string
     */
    protected $_code = 'hyperpay_stc';
    protected $_formBlockType = 'hyperpay/payment_form_stc';

    /**
     *
     * @var string
     */
    protected $_methodCode = 'stc';
    protected $_accountBrand = 'STC_PAY';
